...
def llcopy(head: ListNode)->ListNode:
    dummy = head
    dummyhead = dummy
    while head:
...
if __name__ == "__main__":
    ...
    # print(substring(ss2head, ss1head))
    # maxpalindrome(s1head)
    # print(palindrome(p4head))
    # print(palindrome(l1head))
    # printnode2(slicing(p1head, 1, 3))
    # printnode(reverse(l1head))
    ...
    # maxpalindrome(l2head)
    # printnode(l1head)
    # print(substring(l1head, l2head), substring(l1head, l3head), substring(l1head, l4head), substring(l1head, l5head), substring(l1head, l6head)) # 1 0 1 1 0
    # print(reverse(l1head).val, reverse(l2head).val, reverse(l3head).val, reverse(l4head).val, reverse(l5head).val, reverse(l6head).val)
    # print(reverse(p1head).val)
    # print(palindrome(p1head))
    # print(palindrome(p1head), palindrome(p2head), palindrome(p3head), palindrome(p4head))