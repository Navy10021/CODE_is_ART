...
// 주어진 string을 Split했을 때 최장길이의 문장별 팰린드롬 찾기 : merchant -> just 1 parition(split) / "ghiabcdefhelloadamhelloabcdefghi" -> 7 partitions "(ghi)(abcdef)(hello)(adam)(hello)(abcdef)(ghi)". 
